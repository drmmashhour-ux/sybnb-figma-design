...
const copy = {
  ar: {
    ...
    next: 'التالي',
    title: 'IMMOContact',
    subtitle: 'مركز تواصل موحد لكل طلبات الحجز والزيارة والدفع والهدايا ورحلات SYBNB Ride.',
    refresh: 'تحديث',
    loading: 'جار التحميل',
  ...
  en: {
    ...
    next: 'Next',
    title: 'IMMOContact',
    subtitle: 'A single contact center for booking, visit, payment, gift, and SYBNB Ride follow-up.',
    refresh: 'Refresh',
    loading: 'Loading',
