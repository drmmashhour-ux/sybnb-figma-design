...
const copy = {
  ar: {
    ...
    aiBrainInstantTitle: 'AI Brain: طلبك مقبول مبدئياً',
    aiBrainInstantCopy: 'راجع الذكاء الاصطناعي بيانات حجزك ولم يجد أي مانع. يمكنك المتابعة للدفع الآن بأمان — تبقى مراجعة إثبات الدفع من فريق SYBNB قبل التأكيد النهائي.',
    ...
    guaranteeRows: ['لن يتحول المبلغ للمضيف قبل التأكيد', 'كل الإثباتات محفوظة داخل النظام', 'دعم النزاع متاح خلال 48 ساعة'],
  ...
  en: {
    ...
    aiBrainInstantTitle: 'AI Brain: Your request is pre-approved',
    aiBrainInstantCopy: 'AI Brain reviewed your booking details and found no issues. You can proceed to payment now — SYBNB still reviews the payment proof before final confirmation.',
    ...
    guaranteeRows: ['Funds are not released before confirmation', 'All proofs are stored inside the system', 'Dispute support available within 48 hours'],
