...
const copy = {
  ar: {
    ...
    idGateCopy: 'اكتب اسمك ورقم هاتفك وبريدك الإلكتروني حتى نتمكن من التواصل معك بخصوص هذه الرحلة وإرسال تأكيد حجزك، ولتتمكن لاحقاً من متابعة حجزك برقم التأكيد.',
  ...
  en: {
    ...
    idGateCopy: "Tell us your name, phone, and email so we can reach you about this trip and send your confirmation, and so you can track your booking later with your confirmation number.",
