...
const S: Record<string, CSSProperties> = {
  ...
  row: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 10, textAlign: 'start', background: '#12141d', borderWidth: 1, borderStyle: 'solid', borderColor: 'rgba(255,255,255,.08)', borderRadius: 10, padding: '10px 12px', cursor: 'pointer', color: '#e8ecf3' },
  ...
  badge: { fontSize: 11, fontWeight: 800, borderWidth: 1, borderStyle: 'solid', borderRadius: 999, padding: '3px 9px', whiteSpace: 'nowrap' },
