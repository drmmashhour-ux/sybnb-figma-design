...
const styles: Record<string, CSSProperties> = {
  ...
  table: { border: '1px solid #242735', borderRadius: 8, background: '#101016', overflow: 'hidden' },
  tableHead: { display: 'grid', gridTemplateColumns: 'minmax(160px, 2fr) minmax(140px, 1.2fr) 110px 130px 130px 140px', gap: 12, padding: '14px 18px', borderBottom: '1px solid #242735', color: '#8d92a2', fontSize: 13 },
  tableRow: { display: 'grid', gridTemplateColumns: 'minmax(160px, 2fr) minmax(140px, 1.2fr) 110px 130px 130px 140px', gap: 12, alignItems: 'center', padding: '16px 18px', borderBottom: '1px solid #242735', fontSize: 14 },
