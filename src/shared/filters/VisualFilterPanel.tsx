...
const styles: Record<string, CSSProperties> = {
  ...
  legend: { color: '#c4cce0', fontSize: 17, fontWeight: 950, padding: '0 8px' },
  ...
  label: { fontSize: 15, fontWeight: 950, lineHeight: 1.25, maxWidth: 132, overflowWrap: 'anywhere', textAlign: 'center' },
